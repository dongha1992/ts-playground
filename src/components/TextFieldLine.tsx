...
import TextFieldLineContainer, { TextFieldLineContainerBaseProps } from './TextFieldLineContainer';

export interface Props
  extends TextFieldLineContainerBaseProps,
    Omit<InputHTMLAttributes<HTMLInputElement>, 'placeholder' | 'onClick'> {}

function TextFieldLine({ className, label, hasError, style, autoComplete = 'off', focused, ...inputProps }: Props) {
